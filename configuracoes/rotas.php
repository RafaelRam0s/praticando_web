...
function convocar_rota(string $rota)
{
    ...
    $lista_de_rotas = [
        ...
        'db/praticando_web/usuario' => '/database/praticando_web/usuario/usuario.php',
        
        'erro/404' => '/public_html/404/index.php',        

        'secure/validacoes_de_cadastro' => '/secure/validacoes_de_cadastro.php',
        'secure/praticando_web/usuario' => '/secure/praticando_web/usuario/usuario.php',
        ...
        'site/sistema_de_registro/cadastro/confirme_email' => '/public_html/sistema_de_registro/cadastro/confirme_email/confirme_email.php',
